...
{
    private readonly ILogger<IndustriesInsideController> _logger;


    public IndustriesInsideController(ILogger<IndustriesInsideController> logger, IConfiguration configuration)
    {
        _logger = logger;   
    }
